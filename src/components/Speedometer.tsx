	...
	return (
		<div className="relative text-center">
			<svg viewBox="0 0 200 100" className="w-full h-full">
				...
				{/* Bakgrunnsbue */}
				<path d="M10,100 A90,90 0 0,1 190,100" fill="url(#gradient)" stroke="none" filter="url(#shadow)" />
			...
			{/* Forklaring under */}
			<p className="mt-2 text-sm font-bold text-neutral_gray">
				{smerteVerdi <= 3 ? " Lav smerte" : smerteVerdi <= 7 ? " Moderat smerte" : " Høy smerte"}
			</p>
		</div>
	);
}
